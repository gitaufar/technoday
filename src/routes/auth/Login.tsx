          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-[13px] text-gray-500">
                Sign in to manage your organization and contracts.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between mb-5">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-300 text-[#357ABD] focus:ring-[#357ABD]"
                />
              ...
              <button
                ...
                className="text-sm text-[#357ABD] hover:underline"
              >
                Forgot Password?
              </button>
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-[#357ABD] text-white rounded-xl py-3.5 font-semibold hover:bg-[#2c6ba8] disabled:opacity-50 disabled:cursor-not-allowed transition-colors mb-5"
            >
